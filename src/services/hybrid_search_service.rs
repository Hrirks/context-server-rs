...
use crate::services::semantic_search_service::{
    EnhancedSearchResult, SemanticSearchError, SemanticSearchService,
};
...
impl HybridSearchServiceImpl {
    ...
    fn determine_search_strategy(&self, query_text: &str) -> SearchStrategy {
        ...
        if query_lower.contains("business rule")
            || query_lower.contains("architectural decision")
        ...
        if query_lower.contains("how to")
            ...
            || query_lower.contains("best practice")
    ...
    fn convert_traditional_to_enhanced(
        &self,
        traditional_results: &ContextQueryResult,
        project_id: &str,
    ) -> Vec<EnhancedContextItem> {
...
impl HybridSearchService for HybridSearchServiceImpl {
    async fn hybrid_search(
        ...
        info!(
            "Hybrid search completed: {} total results with combined score {:.3}",
...
mod tests {
    use super::*;
    use crate::models::embedding::VectorSearchQuery;
    use crate::models::embedding::{ResultMetadata, VectorSearchResult};
    ...
    impl SemanticSearchService for MockSemanticSearchService {
        ...
        async fn get_index_stats(
            &self,
            _project_id: Option<&str>,
        ) -> Result<crate::services::semantic_search_service::SearchIndexStats, SemanticSearchError>
        {
    ...
    async fn test_hybrid_search() {
        ...
        let hybrid_service =
            HybridSearchServiceImpl::new(semantic_service, context_service, config);
    ...
    async fn test_search_suggestions() {
        ...
        let suggestions = hybrid_service
